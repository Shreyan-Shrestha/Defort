...
<body class="d-flex flex-column min-vh-100">
    <nav class="navbar justify-content-center navbar-dark navbar-expand-lg sticky-top" style="background: radial-gradient(circle, rgba(0, 119, 203, 1) 0%, rgba(0, 131, 224, 1) 64%, rgba(16, 124, 255, 1) 100%); padding: 10px 0;">
